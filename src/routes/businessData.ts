...
router.put('',
    body('ruc')
        .notEmpty().withMessage('El ruc del negocio es obligatorio'),
    body('name')
        .notEmpty().withMessage('El nombre del negocio es obligatorio'),
    body('direction')
        .notEmpty().withMessage('La dirección del negocio es obligatorio'),
    body('description')
        .notEmpty().withMessage('La descripión de los datos del negocio es obligatorio'),
    body('telephone')
        .notEmpty().withMessage('El teléfono del negocio es obligatorio'),
    ErrorsValidation,
