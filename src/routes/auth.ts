...
router.post('/create-account',
    ...
    body('password')
        ...
        .isLength({ min: 6 }).withMessage('El password debe tener mínimo 6 carácteres'),
    ErrorsValidation,
...
router.post('/confirm-account',
    body('token')
        .isLength({ min: 6, max: 6 }).withMessage('El token no es válido'),
    ErrorsValidation,
...
router.post('/login',
    body('email')
        .isEmail().withMessage('El email no es válido'),
    body('password')
        .notEmpty().withMessage('El password no es válido'),
    ErrorsValidation,
...
router.get('/update-password',
    ...
    body('newPassword')
        .notEmpty().withMessage('El password es obligatorio')
        .isLength({ min: 6 }).withMessage('El password debe ser mínimo 6 caracteres'),
    ErrorsValidation,
